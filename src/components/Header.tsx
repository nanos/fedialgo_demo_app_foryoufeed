        ...
        <Container className='w-100 m-3'>
            <Row className='w-100 m-3'>
                <Col xs={4} className="p-0">
                    {
                        user && <div className='text-center d-inline align-middle'>
                            {user?.profilePicture &&
                                <img
                                    src={user.profilePicture} alt="Avatar" style={{ height: 30, width: 30, borderRadius: 5 }}
                ...
                <Col xs={4} className='text-center p-0'>
                    ...
                    <span className='text-center align-middle p-2' style={{ fontSize: 20, whiteSpace: "nowrap" }}>
                        Fedi-Feed
                    </span>
                </Col>
